...
- Updated `vwo-fme-node-sdk` and `wingify-fme-node-sdk` dependencies to version `^1.62.0` to support internal events sampling.

## [1.56.0] - 2026-08-25

### Fixed

- Fix: mark VWOProvider ready-state updates as transitions (by Chris Campbell)
